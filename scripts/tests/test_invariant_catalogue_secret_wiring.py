"""Invariant-catalogue consumer wiring: invariant_catalogue.py must resolve its bearer through the SECRETS-V3
...
TARGET = SCRIPTS / "invariant_catalogue.py"
TOKEN_VAR = "DOCPLANE_INVARIANT_CATALOGUE_TOKEN"
...
def test_consumer_prefers_the_file_over_a_stale_environment_value(tmp_path, monkeypatch):
    ...
    carries a legacy bearer while the runtime file is the intended source. The invariant catalogue is
