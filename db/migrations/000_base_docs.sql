-- DocPlane authored-document base schema.
--
-- This is deliberately idempotent so an existing installation created by the historical
-- db/init.sql can enter the numbered migration ledger without reconstructing or rewriting data.
